...
$controllers = ["admin", "inscription","connexion","deconnexion","pagelogement","accueil","aide","mdp_oublie","changement_mdp", "annonces", "ajoutLogement"];
//Nom du contrôleur par défaut-- A RENSEIGNER
$controller_default = "ajoutLogement";
