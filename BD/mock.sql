...
(12, 'Rue de la Faisanderie', 75016, 'Paris'),
...
('Maison', 120, 2, 2500, 200, '2023-01-02', 2, 1, 1, 1, 5, 1, 'Maison spacieuse avec jardin'),
('Appartement', 30, 3, 800, 50, '2023-01-03', 3, 1, 1, 1, 1, 0, 'Petit appartement cosy'),
('Maison', 150, 4, 3000, 250, '2023-01-04', 4, 1, 1, 1, 6, 1, 'Grande maison familiale'),
('Appartement', 45, 5, 1100, 90, '2023-01-05', 5, 1, 1, 1, 2, 0, 'Appartement lumineux'),
('Maison', 200, 6, 3500, 300, '2023-01-06', 6, 1, 1, 1, 7, 1, 'Maison de luxe avec piscine'),
('Appartement', 60, 7, 1400, 120, '2023-01-07', 7, 1, 1, 1, 3, 1, 'Appartement spacieux'),
('Maison', 180, 8, 3200, 270, '2023-01-08', 8, 1, 1, 1, 6, 1, 'Maison moderne avec jardin'),
('Appartement', 35, 9, 900, 70, '2023-01-09', 9, 1, 1, 1, 1, 0, 'Appartement bien situé'),
('Maison', 160, 10, 2800, 230, '2023-01-10', 10, 1, 1, 1, 5, 1, 'Maison confortable'),
('Appartement', 55, 11, 1300, 110, '2023-01-11', 11, 1, 1, 1, 2, 1, 'Appartement moderne'),
('Maison', 190, 12, 3400, 290, '2023-01-12', 12, 1, 1, 1, 7, 1, 'Maison spacieuse avec jardin'),
('Appartement', 40, 13, 1000, 80, '2023-01-13', 13, 1, 1, 1, 1, 0, 'Appartement cosy'),
('Maison', 170, 14, 3100, 260, '2023-01-14', 14, 1, 1, 1, 6, 1, 'Maison familiale'),
